...
struct point {
    ...
    здесь нужно было добавить написать m_y = y  вместо y = y,
    синтаксически верно так и так,
    но семантически будет верен первый вариант, но я решил сделать все немного лаконичнее
*/        
        //m_x = x;
       // m_y = y; 
